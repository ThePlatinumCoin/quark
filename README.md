...
Copyright (c) 2014 Platinum Developers
...
Intro
---------------------
Platinum is a free open source peer-to-peer electronic cash system that is
...
Setup
---------------------
You need the Qt4 run-time libraries to run Platinum-Qt. On Debian or Ubuntu:
